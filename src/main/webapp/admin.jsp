			...
			<div id="management">
				<div id="student1">
					...
					<div>
						...
						<br /> <span id="lectureSelect_box"> <label class="label"
							for="" id="selectLabel">강의명 : </label> <!-- 			<input type="text" name="강의명" id="lecture_name" value="" /> -->
						...
						</span> <span id="nameBox"> <label id="labelName" for=""></label>
							<input type="text" name="nameText" id="nameText" value="" />
						</span> <br /> <span id="student_regist_search"> <label
							class="label" for="">강의 일자별 조회 : </label> <input type="date"
							name="registDateStart" id="registDateStart" />~<input
							type="date" name="registDateEnd" id="registDateEnd" />
						</span> <input type="button" id="search" value="조회" /> <input
							type="button" id="reset" value="초기화" />

						<div id="register_or_modify">
							<input type="button" id="register_btn" value="등록" /> <input
								type="button" id="modify_btn" value="편집" />
						</div>
		...
		<div id="container2">
			<div id="student1">
				...
				<div>
					...
					</select> <span> <input type="button" id="account_modify_btn"
						value="편집" />
					</span>
